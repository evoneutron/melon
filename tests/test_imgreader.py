import pathlib
from unittest import TestCase, mock, main, skip
...
class ImageReaderTestCase(TestCase):
    ...
    def test_one_hot_result_shape(self):
        self.reader = ImageReader("tests/resources/images", {"label_encoder": "one_hot"})
        x, y = self.reader.read()
    ...
    def test_batch_read(self):
        reader = ImageReader("tests/resources/images", {"batch_size": 2})
